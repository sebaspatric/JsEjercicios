...
function agregarProducto() {
  ...
  let seleccion = parseInt(prompt(mensajeProductos + "Seleccione el número del producto que desea agregar:"));
  ...
  // Solicitar la cantidad de unidades que desea agregar
  let cantidad = parseInt(prompt(`¿Cuántas unidades de ${productoSeleccionado.nombre} desea agregar al carrito?`));
  ...
  alert(`${cantidad} unidad(es) de ${productoSeleccionado.nombre} agregado(s) al carrito.`);
  ...
  if (seguirAgregando !== "sí" && seguirAgregando !== "si") {
      return; // Salir de la función si no desea seguir agregando productos
  } else {
...
function eliminarProducto() {
  ...
  let index = parseInt(prompt("Ingrese el número del producto que desea eliminar del carrito:")) - 1;
