document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateTimeAndDate() {
     ...
     setInterval(updateTimeAndDate, 1000); // Actualizar cada segundo
    ...
    flightBox.appendChild(flightTitle);
     ...
     // Generar número de vuelo y terminal de forma aleatoria
     ...
     flightNumberElement.innerHTML = `Número de vuelo: <em id="flightNumber">${flightNumber}</em>`;
     flightBox.appendChild(flightNumberElement);

     const terminalNumberElement = document.createElement("h3");
     terminalNumberElement.innerHTML = `Terminal: <em id="terminalNumber">${terminalNumber}</em>`;
