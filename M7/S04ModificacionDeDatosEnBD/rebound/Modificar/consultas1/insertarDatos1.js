...
cliente.connect(err => {
  ...
  const insertarCursos = `
    INSERT INTO cursos (titulo, descripcion) VALUES
      ('Programacion 1', 'Descripcion de programacion 1'),
      ('Programacion 2', 'Descripcion de programacion 2'),
      ('Programacion 3', 'Descripcion de programacion 3'),
      ('Bases de Datos 1', 'Descripcion de Bases de Datos 1'),
      ('Bases de Datos 2', 'Descripcion de Bases de Datos 2'),
      ('Bases de Datos 3', 'Descripcion de Bases de Datos 3'),
      ('Bootcamp IA', 'Descripcion de Bootcamp IA');
  `;
